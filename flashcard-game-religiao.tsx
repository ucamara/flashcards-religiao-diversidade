...
import { BookOpen, Star, RotateCcw, Eye, Trophy } from 'lucide-react';
...
const FlashcardGame = () => {
  ...
  const [modo, setModo] = useState('menu'); // menu, estudo, jogo
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 p-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="hover:shadow-xl transition-all cursor-pointer transform hover:-translate-y-2" onClick={iniciarEstudo}>
            ...
            <Card className="hover:shadow-xl transition-all cursor-pointer transform hover:-translate-y-2" onClick={iniciarJogo}>
              <CardContent className="p-8 text-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <Card 
          className="shadow-2xl cursor-pointer transform transition-all hover:scale-102 min-h-[400px]"
